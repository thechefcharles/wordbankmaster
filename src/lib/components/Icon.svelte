<script>
	...
	const SVG = {
		...
		snowflake: `<svg ${A}><path d="M12 3v18M4.2 7.5l15.6 9M19.8 7.5l-15.6 9"/><path d="M9.8 4.4L12 6.6l2.2-2.2M9.8 19.6L12 17.4l2.2 2.2M4.1 9l3 .3.5-3M19.9 15l-3-.3-.5 3M4.6 15.3l.4-3-3-.3M19.4 8.7l-.4 3 3 .3"/></svg>`,
		palette: `<svg ${A}><path d="M12 3.5c-4.7 0-8.5 3.5-8.5 8 0 2.7 2.2 4.3 4.6 4.3H10a1.7 1.7 0 0 1 1.5 2.6c-.4.8.2 2 1.3 2 4.3 0 8.2-3.8 8.2-8.4 0-4.9-3.8-8.5-8.5-8.5z"/><circle cx="7.5" cy="11.5" r=".9"/><circle cx="12" cy="8.5" r=".9"/><circle cx="16.5" cy="11.5" r=".9"/></svg>`,
		flag: `<svg ${A}><path d="M6 3.5v17"/><path d="M6 4.5h11l-2.3 3.3L17 11.2H6"/></svg>`,
